/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f7da487fc254db52d5104435630c5906)
// Runtime types generated with workerd@1.20260815.1 2026-07-23 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	HYPERDRIVE_FRESH: Hyperdrive;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://leetbattle.cenough.games";
	...
	RUNNER_INTERNAL_SECRET: string;
	ROOM_INVITE_SECRET: string;
	REALTIME_NOTIFY_SECRET: string;
	OPENAI_API_KEY: string;
	RUNNER_SERVICE: Fetcher /* leetbattle-runner */;
	REALTIME_SERVICE: Fetcher /* leetbattle-realtime */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "OPENAI_JUDGE_MODEL" | "OPENAI_JUDGE_MAX_DAILY_REQUESTS" | "OPENAI_JUDGE_MAX_DAILY_REQUESTS_PER_USER" | "OPENAI_JUDGE_MAX_DAILY_REQUESTS_PER_MATCH" | "CLERK_SECRET_KEY" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "REALTIME_TICKET_SECRET" | "RUNNER_INTERNAL_SECRET" | "ROOM_INVITE_SECRET" | "REALTIME_NOTIFY_SECRET" | "OPENAI_API_KEY">> {}
}
