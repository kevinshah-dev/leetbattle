/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/realtime/wrangler.jsonc cloudflare/realtime/worker-configuration.d.ts` (hash: 54ed23cc46ea480e3e8f843a537522aa)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "REALTIME_TICKET_SECRET" | "ROOM_INVITE_SECRET" | "REALTIME_NOTIFY_SECRET">> {}
}
