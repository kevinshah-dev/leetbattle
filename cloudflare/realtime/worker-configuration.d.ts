/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/realtime/wrangler.jsonc cloudflare/realtime/worker-configuration.d.ts` (hash: 353d3cfc314b562381fcfcf31a2b9f59)
...
interface __BaseEnv_Env {
	...
	ROOM_HUB: DurableObjectNamespace<import("./src/index").RoomHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RoomHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "OPENAI_JUDGE_MODEL" | "OPENAI_JUDGE_MAX_DAILY_REQUESTS" | "OPENAI_JUDGE_MAX_DAILY_REQUESTS_PER_USER" | "OPENAI_JUDGE_MAX_DAILY_REQUESTS_PER_MATCH" | "REALTIME_TICKET_SECRET" | "ROOM_INVITE_SECRET" | "REALTIME_NOTIFY_SECRET" | "OPENAI_API_KEY">> {}
}
