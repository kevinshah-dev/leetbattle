/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/runner/wrangler.jsonc cloudflare/runner/worker-configuration.d.ts` (hash: e25ad7749270abd1efec0ba3a83357ad)
// Runtime types generated with workerd@1.20260721.1 2026-07-23 nodejs_compat
interface __BaseEnv_Env {
	SANDBOX_TRANSPORT: "rpc";
	RUNNER_INTERNAL_SECRET: string;
	JUDGE_SANDBOX: DurableObjectNamespace<import("./src/index").JudgeSandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "JudgeSandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SANDBOX_TRANSPORT" | "RUNNER_INTERNAL_SECRET">> {}
}
